...
function printAlbum(data) {
    ...
    for (let i = 0; i < data.tracks.data.length; i++) {
        ulSongs.innerHTML += `<li class="col-1 text-end text-gray-light gerardo">${i + 1}</li>
                <li class="col-4 gerardo">${data.tracks.data[i].title}</li>
                <li class="col-4 text-gray-light gerardo">${data.tracks.data[i].rank}</li>
                <li class="col-3 text-end pe-5 text-gray-light gerardo">${durationTime(data.tracks.data[i].duration)}</li>`;
    }
}
