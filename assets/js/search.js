...
const imgCanzone = document.querySelectorAll(".imgCanzone");
const imgAlbumart = document.querySelectorAll(".imgAlbumartist");
const imgRandomartist = document.querySelectorAll(".imgRandomarist");
const randomArtist = document.querySelectorAll(".randomArtist");
